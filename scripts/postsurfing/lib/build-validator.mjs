...
export class BuildValidator {
            ...
            return {
                ...
                analysis: {
                    ...
                    suggestions: [
                        ...
                        'Verify dependencies via bun install',
                    ],
                },
            };
        }
    ...
    async runBuild() {
        return new Promise((resolve) => {
            this.logger.infoVerbose('Running bun run build...');
    ...
    extractAffectedFiles(output) {
        ...
        const files = new Set(matches.map((match) => match[0]));
    ...
    addSpecificSuggestions(analysis) {
        switch (analysis.type) {
            ...
            case 'typescript_error':
                analysis.suggestions.push(
                    'Run "bun run check:astro" for detailed type checking',
            ...
            case 'import_error':
                analysis.suggestions.push(
                    ...
                    'Verify dependencies are installed via bun install',
            ...
            case 'memory_error':
                analysis.suggestions.push(
                    'Increase Node.js memory: NODE_OPTIONS="--max-old-space-size=4096" bun run build',
            ...
            default:
                analysis.suggestions.push(
                    ...
                    'Try running "bun run check" for additional validation',
