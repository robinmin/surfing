...
console.log(
  ...
  import.meta.env?.PUBLIC_GOOGLE_CLIENT_ID ? '✅ Set' : '❌ Missing'
)
console.log('PUBLIC_SUPABASE_URL:', import.meta.env?.PUBLIC_SUPABASE_URL ? '✅ Set' : '❌ Missing')
console.log(
  'PUBLIC_SUPABASE_ANON_KEY:',
  import.meta.env?.PUBLIC_SUPABASE_ANON_KEY ? '✅ Set' : '❌ Missing'
)
...
console.log(
  ...
  window.google?.accounts ? '✅ Available' : '❌ Not available'
)
console.log(
  'window.google.accounts.id:',
  window.google?.accounts?.id ? '✅ Available' : '❌ Not available'
)
