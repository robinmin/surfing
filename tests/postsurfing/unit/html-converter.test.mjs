...
async function testMetaExtraction(converter) {
  ...
  `;
    ...
    utils.assertEqual(
        result.extractedMetadata.description,
        'Test description',
        'Should extract description'
    );
    utils.assertEqual(result.extractedMetadata.author, 'Test Author', 'Should extract author');
    utils.assert(
        Array.isArray(result.extractedMetadata.keywords),
        'Should extract keywords as array'
    );
    utils.assertEqual(
        result.extractedMetadata.responsive,
        true,
        'Should detect responsive meta tag'
    );
