...
async function testSimpleMarkdown(processor) {
    ...
    utils.assertEqual(
        result.metadata.extractedTitle,
        'Simple Test Article',
...
async function testMarkdownWithFrontmatter(processor) {
    ...
    utils.assert(
        Array.isArray(result.metadata.existingFrontmatter.tags),
        'Should parse tags as array'
    );
...
async function testOutputPath(processor) {
    ...
    utils.assertContains(
        outputPath,
        'contents/articles/en',
        'Should use correct content directory with language'
    );
    utils.assertContains(
        outputPath,
        'my-article.md',
        'Should preserve filename with .md extension'
    );
