...
customJS: |
  const elements = {
          ...
          function displayResults(colors) {
              ...
              elements.cssOutput.textContent = cssText;
          }
...
tags: ["typescript", "angular", "css", "html", "python"]
readingTime: 1
wordCount: 16
        ...
        <div class="controls">
            <div class="color-input-group">
                ...
                <div class="color-picker-row">
                    <input type="color" id="fromColorPicker" value="#ff0000">
                    <div class="hex-input">
                        <input type="text" id="fromHex" value="#FF0000" placeholder="#FF0000">
                    </div>
                </div>
            </div>
            ...
            <div class="color-input-group">
                ...
                <div class="color-picker-row">
                    <input type="color" id="toColorPicker" value="#0000ff">
                    <div class="hex-input">
                        <input type="text" id="toHex" value="#0000FF" placeholder="#0000FF">
                    </div>
                </div>
            </div>
            ...
            <div class="segments-control">
                ...
                <input type="number" id="segments" min="1" max="20" value="5">
            </div>
